...
val mockitoVersion = "4.10.0"          // https://mvnrepository.com/artifact/org.mockito/mockito-junit-jupiter
...
pluginBundle {
    tags = tags + listOf("blackbox", "testing", "test", "integration-test", "test automation")
}
